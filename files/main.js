...
const addSymbols = () => {
  if (symbol.checked) {
    possibleCharacters = possibleCharacters.concat(symbolsArr);
    incrementCount();
  } else {
    possibleCharacters = possibleCharacters.filter(
      (char) => !symbolsArr.includes(char)
    );
    decrementCount();
  }
...
const addUpperCaseLetters = () => {
  if (uppercaseLetter.checked) {
    possibleCharacters = possibleCharacters.concat(uppercaseLettersArr);
    incrementCount();
  } else {
    possibleCharacters = possibleCharacters.filter(
      (char) => !uppercaseLettersArr.includes(char)
    );
    decrementCount();
  }
  generatePassword(passwordLength);
...
const addLowerCaseLetters = () => {
  if (lowercaseLetter.checked) {
    possibleCharacters = possibleCharacters.concat(lowercaseLettersArr);
    incrementCount();
  } else {
    possibleCharacters = possibleCharacters.filter(
      (char) => !lowercaseLettersArr.includes(char)
    );
    decrementCount();
  }
  generatePassword(passwordLength);
